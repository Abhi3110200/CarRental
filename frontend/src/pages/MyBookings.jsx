...
const MyBookings = () => {
    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32  mt-16 text-sm max-w-7xl mx-auto">
            <Title title="My Bookings" subTitle="View an manage your all car bookings" align="left"/>
            <div>
