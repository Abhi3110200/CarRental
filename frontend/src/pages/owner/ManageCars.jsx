                            ...
                            cars.map((car, index) => (
                                <tr key={index} className="border-t border-borderColor">
                                    <td className="p-3 flex items-center gap-3">
                                        <img src={car.image} alt="car" className="w-12 h-12 object-cover rounded-md aspect-square" />
                                    ...
                                    <td className="p-3 flex items-center">
                                        ...
                                        <img src={assets.delete_icon} alt="" onClick={() => deleteCar(car._id)} className="cursor-pointer" />
                                    </td>
                                </tr>
                            ))
                        )}
